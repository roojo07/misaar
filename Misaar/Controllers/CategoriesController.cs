...
namespace Misaar.Controllers
{
    public class CategoriesController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "Id,Name,MenuPosition,Description,KeyWords,MetaDescription")] Category category, HttpPostedFileBase upload)
        {
        ...
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> EditPost([Bind(Include = "Id,Name,MenuPosition,Description,KeyWords,MetaDescription")] int? id, HttpPostedFileBase upload)
        {
            if (id == null)
            {
                return new HttpStatusCodeResult(HttpStatusCode.BadRequest);
            ...
            if (TryUpdateModel(category, "",
                new string[] { "Name", "MenuPosition", "Description", "KeyWords", "MetaDescription" }))
            {
                try
                {
                    if (upload != null && upload.ContentLength > 0)
                    ...
                    {
                        productsArr[i].Category = categ.Name;
